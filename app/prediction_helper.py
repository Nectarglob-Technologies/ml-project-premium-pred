...
model_young = joblib.load(os.path.join("app", "artifacts", "model_young.joblib"))
model_rest = joblib.load(os.path.join("app", "artifacts", "model_rest.joblib"))
scaler_young = joblib.load(os.path.join("app", "artifacts", "scaler_young.joblib"))
scaler_rest = joblib.load(os.path.join("app", "artifacts", "scaler_rest.joblib"))
...
def preprocess_input(input_dict):
    ...
    # Assuming the 'normalized_risk_score' needso be calculated based on the 'age'
